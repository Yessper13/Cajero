...
function registro() {
    ...
    do {
        ...
        switch (tipoId) {
            ...
            case 2:
                ...
                break;
            case 3:
                tipoIdent[contRegistro] = "DNI";//se almacena NIT en el array tipoIdent en la posición de contRegistro
                break;
            default:
    ...
    } while (confirmarOpcion(completoID) != 1);//funcion ubicada en login.js
